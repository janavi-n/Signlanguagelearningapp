...
import { Hand, Mail, Lock, Eye, EyeOff, UserPlus } from 'lucide-react';
    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Welcome to SignSpeak</h1>
          <p className="text-gray-600 mt-2">Start your sign language journey today</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3.5 border-2 border-gray-200 rounded-xl focus:border-purple-500 focus:outline-none transition-colors"
                  required
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              className="w-full py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl hover:shadow-lg transition-all mt-6"
            >
          ...
          <button
            ...
            className="w-full py-3.5 border-2 border-gray-300 rounded-xl hover:bg-gray-50 transition-colors flex items-center justify-center gap-3 font-medium text-gray-700"
          >
          ...
          <button
            ...
            className="w-full mt-3 py-3.5 text-gray-600 hover:text-gray-800 font-medium transition-colors"
          >
            Continue as Guest
          </button>
